            ...
            <tr style="vertical-align: top">
                <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                    ...
                    <div class="u-row-container" style="padding: 0px;background-color: transparent">
                        <div class="u-row"
                            style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #f3f3f3;">
                            <div
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ asset('/images/Logo%20Big.png')}}"
                                                                            alt="Logo" title="Logo"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1
                                                                style="margin: 0px; color: #292929; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Raleway',sans-serif; font-size: 48px;">
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 160%;">Jalan Medan Merdeka Barat No. 21, Jakarta 10110 | Indonesia Telp : (62-21) 3000 30001 | Website : keinabeauty.com</p>
                                                                <p style="font-size: 14px; line-height: 160%;">Keina Beauty | Privacy Policy</p>
                                                            </div>
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">&copy;
                                                                   Keina Beauty. All Rights Reserved.</p>
                                                            </div>
